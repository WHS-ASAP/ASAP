...
class WebViewAnalyzer:
    ...
    def permissions_in_app_webview(self,xml_path, keyword):
        ...
        dangerous_keywords, dangerous_permissions = analyzer.run_jsmethod(xml_path, keyword)
                ...
                if os.path.exists(whole_path):
                    ...
                    if webview_lines:
                        ...
                        result_dict = {
                            ...
                            "permission with javascript_lines": (dangerous_keywords, dangerous_permission)
                        }
